...
namespace AspNetIdentityDemo.Api.Sevices
{
    ...
    public class UserService : IUserService
    {
        ...
        public async Task<UserManagerResponse> ForgotPasswordAsync(string email)
        {
            ...
            await _mailService.SendEmailAsync(email,"Reset Password","<h1>follow the insructions to reset the password</h1>"+
                $"<p>to reset <a href='{url}'>click here</a></p>");
            return new UserManagerResponse
            {
                
                IsSuccess = true,
                Message = "Reset password url has been sent to email sucessfully",
            };
